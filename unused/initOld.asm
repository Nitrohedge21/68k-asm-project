...
; Written by : BigEvilCorporation
; Date       : 12.02.2024
; Description: I followed their tutorial series to create this file.
;===================================================================;
...
; ******************************************************************
	...
	dc.b "SONIC 4 REAL!!                                  " ; Domestic name
...
;Presumably where the actual code starts - Ersan
...
;Required to write data to Z80 Chip
...
;Initializing the PSG - Programmable Sound Generator
...
;The code below is used to enable minimum things necessary to get this running
;Initializing the controller ports
; Set IN I/O direction, interrupts off, on all ports (Not sure how this part actually works but it is necessary - Ersan)
...
;Clearing the registers and tidying up before starting the actual game code
...
;Everything is set up and ready to go after this point. - Ersan
Main:
    jmp __main        ; 'Jumps' into the main code
